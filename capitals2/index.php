<html>
    ...
    <body>	
        <?php
			...
			include_once ($_SERVER['DOCUMENT_ROOT'] . "/capitals2/read.php");
			include_once ($_SERVER['DOCUMENT_ROOT'] . "/capitals2/add.php");
			include_once ($_SERVER['DOCUMENT_ROOT'] . "/capitals2/update.php");
			include_once ($_SERVER['DOCUMENT_ROOT'] . "/capitals2/delete.php");
