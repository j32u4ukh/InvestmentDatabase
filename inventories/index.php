<html>
    ...
    <body>	
        ...
        <?php
			...
			include_once ($_SERVER['DOCUMENT_ROOT'] . "/inventories/read.php");
			include_once ($_SERVER['DOCUMENT_ROOT'] . "/inventories/add.php");
			include_once ($_SERVER['DOCUMENT_ROOT'] . "/inventories/update.php");
			include_once ($_SERVER['DOCUMENT_ROOT'] . "/inventories/delete.php");
