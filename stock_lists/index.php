...
<!--         <form action='./index.php' method='post'>
        ...
        <?php
			...
			include_once ($_SERVER['DOCUMENT_ROOT'] . "/stock_lists/read.php");
			include_once ($_SERVER['DOCUMENT_ROOT'] . "/stock_lists/add.php");
			include_once ($_SERVER['DOCUMENT_ROOT'] . "/stock_lists/update.php");
			include_once ($_SERVER['DOCUMENT_ROOT'] . "/stock_lists/delete.php");
